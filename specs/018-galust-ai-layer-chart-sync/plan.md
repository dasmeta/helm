...
**Scale/Scope**: Two charts (`base`, `galust-ai-layer`), one base example, umbrella example overlay, Speckit artifacts under `specs/018-galust-ai-layer-chart-sync/`
...
- [x] **Versioning & Compatibility**: `galust-ai-layer` 0.2.x (component-set change); `base` 0.3.32 (additive, backward compatible).
...
```text
specs/018-galust-ai-layer-chart-sync/
├── plan.md
├── spec.md
├── research.md
├── data-model.md
...
- [x] Version bumps included (`base` 0.3.32, `galust-ai-layer` 0.2.1).
